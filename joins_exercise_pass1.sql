...
-- by removing the last two characters of the film title. For example, for the film “Cars 2”, 
-- the original title would be “Cars”. 
...
--Hint: You will likely need to perform a self-join on the specs table in order to get the movie_id values for both the original films and their sequels. 
